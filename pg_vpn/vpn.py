...
class VPN(Q):
    ...
    def define_loss(self):
        ...
        # self.pi_loss = -tf.reduce_sum(tf.losses.softmax_cross_entropy(self.ac, pi.logits, reduction='none') * self.adv)
        self.pg_loss = self.pi_loss - self.entropy * 0.00

        # self.vf_loss = 0.5 * tf.reduce_sum(tf.square(pi.vf - self.r)) #testing v8
